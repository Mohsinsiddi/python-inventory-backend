...
def test_duplicate_category(client):
    ...
    client.post(
        "/add_category",
        data={"name": "Duplicate Category", "description": "Description 1"},
        follow_redirects=True,
    )

    response = client.post(
        "/add_category",
        data={"name": "Duplicate Category", "description": "Description 2"},
        follow_redirects=True,
    )
...
def test_update_category(client):
    ...
    # Update the category
    response = client.post(
        f"/update_category/{category.id}",
        data={"name": "Clothing Updated", "description": "Updated description"},
        follow_redirects=True,
    )
